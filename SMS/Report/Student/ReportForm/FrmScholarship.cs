...
{
    public partial class FrmScholarship :UserControlBase
    {
        ...
        public void GetFilterRecord()
        {
            try
            {
                ...
                {
                    //contition 0
                    if (Chkgender.Checked == true && cmbgender.SelectedIndex>-1)
                    {
                        dataGridView1.DataSource = dtStudentDetail = Connection.GetDataTable("sp_AllStudentForScholar '" + cmbSession.SelectedValue + "'");
                ...
                if (chkIsScholar.Checked == true)
                {
                    tdv.RowFilter = "IsScholarship='Yes'";
                }
                tdv.Sort = "Name";
        ...
        public override void btnprint_Click(object sender, EventArgs e)
        {
            try
            {
                if (dataGridView1.RowCount > 0)
                {
                    ...
                    if (dataGridView1.RowCount > 0)
                    {
                        ds.WriteXmlSchema(@"" + Connection.GetAccessPathId() + @"Barcodes\a\StudentDetailsForScholar.xsd");
                        ...
                        cr.SetParameterValue("ReportTitle",  " Scholarship Details");
        ...
        private void cmbSession_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                dtStudentDetail = Connection.GetDataTable("sp_AllStudentForScholar '" + cmbSession.SelectedValue + "'");
        ...
        private void FrmScholarship_Paint(object sender, PaintEventArgs e)
        {
            //public static void fromClear(Form f);
        }

        private void chkIsScholar_CheckedChanged(object sender, EventArgs e)
        {
            GetFilterRecord();
        }
