...
{
    public partial class FrmCashPyt :UserControlBase
    {
        public FrmCashPyt()
        {
            InitializeComponent();
        ...
        private void FrmCashPyt_Load(object sender, EventArgs e)
        {
        ...
        private void txtvoucherno_Validated(object sender, EventArgs e)
        {
            if (txtvoucherno.Text.Trim() != string.Empty)
            {
                string mysql;
                txtsession.Text = Convert.ToString(school.CurrentSessionCode);
                mysql = "select * from tbl_voucher where sessioncode=" + txtsession.Text + " and  vchtype='CP' and vchno=" + txtvoucherno.Text;
                SqlCommand com;
                ...
                if (reader.HasRows)
                {
                    ...
                    reader.Close();
                    mysql = "select * from tbl_voucherdet where sessioncode=" + txtsession.Text + " and vchtype='CP' and amttype='Dr' and vchno=" + txtvoucherno.Text;
                    com = new SqlCommand(mysql, c.myconn);
        ...
        private void FrmCashPyt_Paint(object sender, PaintEventArgs e)
        {
