...
{
    public partial class FrmDueHostalFee :UserControlBase
    {
        public FrmDueHostalFee()
        {
        ...
        private void btnDueFee_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                DataSet ds = Connection.GetDataSet(mysql);
                if (ds.Tables[1].Rows.Count > 0)
                {
                    ds.WriteXmlSchema(@"" + Connection.GetAccessPathId() + @"\Barcodes\a\FeeNotSubmittedStudent.xsd");
                    Hostal.ReportDesign.rptHostelFeeNotSubmitedStudent r = new Hostal.ReportDesign.rptHostelFeeNotSubmitedStudent();
                    ...
                    f.Text = "Due Hostel Fee By Month";
        ...
        private void FrmDueHostalFee_Load(object sender, EventArgs e)
        {
        ...
        private void FrmDueHostalFee_Paint(object sender, PaintEventArgs e)
        {
