...
namespace SMS {
    ...
    public class rptDueFee : ReportClass {
    ...
    public class CachedrptDueFee : Component, ICachedReport {
        
        public CachedrptDueFee() {
        }
