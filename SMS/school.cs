...
namespace SMS
{
    ...
    class school
    {
        ...
        public void insertstudentdata(string tblname, SqlConnection mcon, Form frm)
        {
            returnconn(myconn);
            DataSet ds1 = new DataSet();
            sqlada = new SqlDataAdapter("select * from " + tblname, mcon);
        ...
        public void showstudentdata(string tblname, SqlConnection mcon, Form frm, string fldname, string mvalue)
        {
            if (mvalue != "")
            {
                returnconn(myconn);
        ...
        public void updatestudentdata(string tblname, SqlConnection mcon, Form frm, string fldname, string mvalue)
        {
