...
namespace SMS
{
    public partial class FormCCEAgrod : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            dtTable.WriteXmlSchema(@"" + Connection.GetAccessPathId() + @"Barcodes\a\AgrodBack1to8.xsd");
        ...
        private void FormCCEAgrod_Load(object sender, EventArgs e)
        {
            try
            {
