...
namespace SMS
{
    public partial class frmNewCCEMarkSheet :UserControlBase
    {
        SqlDataReader dataReader = null;
        bool NonPrimaryFlage;
        static string ttype = string.Empty;
        public frmNewCCEMarkSheet(string TYPE)
        {
        ...
        private void btnViewReport_Click(object sender, EventArgs e)
        {
            ...
            ds = Connection.GetDataSet("SELECT tbl_session.sessioncode, tbl_session.sessionname, tbl_student.studentno,tbl_student.SSMId,tbl_student.ChielId,tbl_student.AdharNo, tbl_student.scholarno, + tbl_student.name as name , + tbl_student.father as father, " +
                    ...
                    "  tbl_sankay.sankayname AS Stream, ISNULL(tbl_StudentAttendance.Lectures, 0) AS [Total Lecture], ISNULL(tbl_StudentAttendance.PresentDays, 0) AS [Total Present],ISNULL(tbl_StudentAttendance.RollNo, 0) AS [Total RollNo],ISNULL(tbl_StudentAttendance.Per , 0) AS [Per]  " +
                    ...
                    " SELECT schoolname,schooladdress,schoolcity,schoolphone,affiliate_by,principal,registrationno,SchoolCode, logoimage FROM tbl_school ");
            ...
            s3.PrintOptions.PaperSize = CrystalDecisions.Shared.PaperSize.PaperA4;
            ...
            {
                s = new rptCCEReportFrontDaffodils();
                s.PrintOptions.PaperOrientation = PaperOrientation.Landscape;
                s.PrintOptions.PaperSize = CrystalDecisions.Shared.PaperSize.PaperA4;
                s.SetDataSource(ds);
                s.SetParameterValue("Class", Connection.GetNextClass(cmbClass.Text.Trim()));
        ...
        private void btnBackView_Click(object sender, EventArgs e)
        {
            ...
            if (cmbClass.Text.Trim().Equals("IX") || cmbClass.Text.Trim().Equals("X"))
            {
                if (ttype.Equals("DAFFO"))
                    s = new rptCCEReportBackDaffo1TO5();
                if(ttype.Equals("LIS"))
                    s = new rptCCEReportBackMpConvent1TO8();
                if(ttype.Equals("AGRO"))
                    s = new rptCCEReportBackAgrod6TO8();
                if (ttype.Equals("Yatharth"))
                    s = new rptCCEReportBackYatharth6TO8();
                s.PrintOptions.PaperOrientation = PaperOrientation.Landscape;
                s.PrintOptions.PaperSize = CrystalDecisions.Shared.PaperSize.PaperA4;
            }
            else if (cmbClass.Text.Trim().Equals("I") || cmbClass.Text.Trim().Equals("II") || cmbClass.Text.Trim().Equals("III") || cmbClass.Text.Trim().Equals("IV")
                  || cmbClass.Text.Trim().Equals("V"))
            {
                ...
                if (ttype.Equals("LIS"))
                    s = new rptCCEReportBackMpConvent1TO8();
                if (ttype.Equals("AGRO"))
                    s = new rptCCEReportBackAgrod1TO5();
                if (ttype.Equals("Yatharth"))
                    s = new rptCCEReportBackYatharth6TO8();
                s.PrintOptions.PaperOrientation = PaperOrientation.Landscape;
                s.PrintOptions.PaperSize = CrystalDecisions.Shared.PaperSize.PaperA4;
            }
            else if (cmbClass.Text.Trim().Equals("VI") || cmbClass.Text.Trim().Equals("VII") || cmbClass.Text.Trim().Equals("VIII"))
            {
                if (ttype.Equals("DAFFO"))
                    s = new rptCCEReportBackDaffo6TO8();
                if (ttype.Equals("LIS"))
                    s = new rptCCEReportBackMpConvent1TO8();
                if (ttype.Equals("AGRO"))
                    s = new rptCCEReportBackAgrod6TO8();
            ...
            else
            {
                ...
                if (ttype.Equals("LIS"))
                    s = new rptCCEReportBackMpConventNUR();
                if (ttype.Equals("AGRO"))
                    s = new rptCCEReportBackFormat3();
                if (ttype.Equals("Yatharth"))
                    s = new rptCCEReportBackYatharth6TO8();
